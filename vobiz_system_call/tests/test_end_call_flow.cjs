...
function instance(){const obj=Object.create(ctx.Class.prototype);obj.state={softphone:{current_call_log:'C1'},active_call:{name:'C1'},auto_dial:{},queue:[]};obj.render_header_active_call=()=>{};obj.is_terminal_status=s=>s==='Completed';
 for(const method of ['stop_browser_softphone_audio','stop_timer','render_browser_softphone','render_queue','render_workdesk_live_call','update_workdesk_primary_action','render_active_call','load'])obj[method]=()=>{};
 return obj;}
(async()=>{
